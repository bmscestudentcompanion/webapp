...
<title>Profile Page | BMSCE Student Companion</title>
...
<h1 style="font-family: monospace; text-align: center; color: white;"><img src="bmsce.png" width="55" height="35"/> PROFILE PAGE</h1>
...
<form action="save_data.php" method="POST">
  ...
  <option value="zimbabwean">Zimbabwean</option>
    ...
    <input type="text" name="father" placeholder="Your Fathers Name..">

    <label>Mother's Name</label>
    <input type="text" name="mother" placeholder="Your Mothers name..">
